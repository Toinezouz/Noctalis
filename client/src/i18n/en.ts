...
export const en = {
  ...
  'home.invited': 'You have an invitation! Pick a name and take your seat.',
  ...
  // --- Lobby --------------------------------------------------------------
  'lobby.share': 'Send this link: up to {max} people can join you',
  'lobby.copy': 'Copy the code',
  'lobby.copied': 'Copied!',
  'lobby.inviteLabel': 'Invite link',
  'lobby.copyLink': 'Copy the link',
  'lobby.shareLink': 'Share the link',
  ...
  'sheet.legendSeen': 'visible at the table (in the open sky or on someone else’s row), so it cannot be yours',
